        ...
        <div class="main-container">
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <div class="validation-msg">Please enter a valid email</div>
                </div>
                <div class="form-group">
                    ...
                    <div class="validation-msg">Password must be at least 8 characters
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="validation-msg">Please select a date</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="validation-msg">Please select a time</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="validation-msg">Please select an option</div>
                </div>
